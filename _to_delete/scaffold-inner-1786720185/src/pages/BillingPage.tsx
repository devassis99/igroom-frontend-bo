...
/**
 * Matches Backoffice.dc.html's B4z frame. As of this mockup revision,
 * "Billing & Plans" split into two separate sidebar sections — the
 * Stripe products/prices management now lives on PlansPage.tsx, and this
 * page keeps just renewals/failed-payments. Sample data — see
 * DashboardPage.tsx's note.
 */
const STATS = [
...
export function BillingPage() {
  return (
    <div>
      <h1 className="m-0 mb-5 font-sans text-2xl font-semibold text-bo-ink">Billing</h1>
